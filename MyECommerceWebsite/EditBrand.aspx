...
<div class="row">
         ...
         <div class="col-md-6">
         <div class="form-group">
                        <label><asp:Literal runat="server" Text="<%$Resources:Resource, EnterBrand %>" /></label>
          ...
          <div class="col-md-6">
             ...
             <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"> <asp:Literal runat="server" Text="<%$Resources:Resource, AllBrands %>" /></h4>
                <br />
